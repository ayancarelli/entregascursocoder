const CrudCarritos = require(`../crud/crudCarrito.js`);
const CrudProductos = require(`../crud/crudProducto.js`);

let myCrudCarritos = new CrudCarritos(`./data/carrito.json`);
let myCrudProductos = new CrudProductos(`./data/productos.json`);
